...
public final class ChangeConfiguration {
	...
	public static Configuration toProperties(final SettingsConfiguration settings, final IModel model) {
		...
		// comma-delimited "Set{a,b,c}" list values by default like config1 did): toSettings() below
		// reads these properties back with pc.getList(...) and expects the 1.x splitting behavior.
