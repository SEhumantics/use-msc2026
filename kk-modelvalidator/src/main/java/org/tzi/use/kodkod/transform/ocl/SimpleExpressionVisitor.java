...
public class SimpleExpressionVisitor implements ExpressionVisitor {
	...
	// The four measurement-uncertainty types (UReal/UInteger/UBoolean/UString) and SBoolean are a
	// later USE fork addition (see ~/msc-4/output/robust_utype_model_finding_proposal.md); this
	// Kodkod-backed crisp finder predates them and does not translate them, same as
	// visitConstUnlimitedNatural/visitOclInState above for other unsupported constructs.
	@Override
	public void visitConstUBoolean(ExpConstUBoolean exp) {
		throw new TransformationException("UBoolean not supported");
	}

	@Override
	public void visitConstSBoolean(ExpConstSBoolean exp) {
		throw new TransformationException("SBoolean not supported");
	}

	@Override
	public void visitConstUInteger(ExpConstUInteger exp) {
		throw new TransformationException("UInteger not supported");
	}

	@Override
	public void visitConstUReal(ExpConstUReal exp) {
		throw new TransformationException("UReal not supported");
	}

	@Override
	public void visitConstUString(ExpConstUString exp) {
		throw new TransformationException("UString not supported");
	}

	@Override
	public void visitUSelect(ExpUSelect exp) {
		throw new TransformationException("uSelect not supported");
	}

	@Override
	public void visitUSelectC(ExpUSelectC exp) {
		throw new TransformationException("uSelectC not supported");
	}
