 ...
 *   commit:   74acd0d
 *   path:     uDataTypes/Libraries/Java/src/uDataTypes/UBoolean.java
 ...
 *      (uDataTypes/UBoolean.java:202) had zero callers anywhere in USE-Uncertainty/src and was
...
public class UBoolean implements Comparable<UBoolean> {
