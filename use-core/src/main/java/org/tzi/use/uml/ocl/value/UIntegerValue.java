...
public final class UIntegerValue extends UncertainValue {
    ...
    /** The squares are taken in double arithmetic; in int arithmetic they
     *  overflow for ordinary operands and turn the uncertainty into NaN. */
    public UIntegerValue multiply(UIntegerValue o) { double x=value, y=o.value;
        return new UIntegerValue(value*o.value, Math.sqrt(y*y*uncertainty*uncertainty + x*x*o.uncertainty*o.uncertainty)); }
    ...
    public URealValue divide(UIntegerValue o) {
        ...
        if (uncertainty == 0) return new URealValue(quotient, o.uncertainty/((double)o.value*o.value));
