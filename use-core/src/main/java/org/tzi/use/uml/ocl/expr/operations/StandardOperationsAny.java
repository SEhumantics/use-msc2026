...
import org.tzi.use.uml.ocl.value.UncertainBooleanValue;
...
final class Op_equal extends OpGeneric {
	...
	public Type matches(Type params[]) {
		...
		boolean someOfThemIsSBooleanValue = params[1] instanceof SBooleanType || params[0] instanceof SBooleanType;
		Type result = null;
...
//--------------------------------------------------------
// Fork-only. Provides `equals` as the CRISP comparison -- the escape hatch for asking
// "are these the same value?" when `=` now answers with a DEGREE instead of a Boolean.
//--------------------------------------------------------
