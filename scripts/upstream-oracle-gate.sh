...
echo "[gate] R-8 (docs/port2/gate-threat-model.md): close or disable this checkout's IDE"
echo "[gate]     Java language server before an acceptance run -- its output folder for a"
echo "[gate]     Maven project is target/classes, which git status cannot see."
